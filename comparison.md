...
| [CommonGround](https://github.com/Intelligent-Internet/CommonGround) | 147 | TypeScript | MIT | 2025-11 | Shared agent workspace: collaborative memory, pub/sub events, agent directory |
...
| [ClawMem](https://github.com/yoloshii/ClawMem) | 198 | TypeScript | MIT | 2026-02-06 | On-device, hybrid BM25+vector+RRF+cross-encoder, 5+ search modes, conflict detection |
| [omega-memory](https://github.com/omega-memory/omega-memory) | 200 | Python | MIT | 2026-01 | 28-tool multi-agent memory, 5 search modes, all lifecycle features, LongMemEval 76.8% |
...
| [AIPass](https://github.com/AIOSAI/AIPass) | 254 | Python | MIT | 2026-02 | CLI-native agent workspace, ChromaDB, auto-rollover, no delete |
| [shodh-memory](https://github.com/varun29ankuS/shodh-memory) | 268 | Rust | ? | 2025-12-03 | Cognitive: learns from use, forgets irrelevant, TinyBERT NER, RichContext |
...
| [stash](https://github.com/alash3al/stash) | 762 | Go | Apache 2.0 | 2026-04-24 | Go binary, 8-stage consolidation pipeline, causal link + hypothesis engine |
| [Wax](https://github.com/christopherkarani/Wax) | 776 | Swift | Apache 2.0 | 2026-01-20 | Swift/Metal, Apple Silicon, single-file, sub-ms RAG, EAV entities, hybrid FTS+HNSW |
| [LightMem](https://github.com/zjunlp/LightMem) | 1079 | Python | MIT | 2025-05 | ICLR 2026: lightweight memory-augmented generation with adaptive gating |
| [token-savior](https://github.com/Mibayy/token-savior) | 1113 | Python | MIT | 2026-03-30 | FTS5+vector hybrid RRF, Tree-sitter code graph, Thompson-sampled persona lattice |
| [mem9](https://github.com/mem9-ai/mem9) | 1183 | TypeScript | Apache 2.0 | 2026-01 | TiDB Cloud backed, hybrid search, multi-agent spaces, conflict resolution, 6 platforms |
| [nocturne](https://github.com/Dataojitori/nocturne_memory) | 1313 | Python | MIT | 2025-12-25 | Rollbackable, visual LTM for MCP agents, no vector RAG, 9 MCP clients |
| [opencode-mem](https://github.com/tickernelz/opencode-mem) | 1339 | TypeScript | ? | 2026-01-10 | OpenCode plugin, local vector DB, dashboard, dedup, persona extraction |
| [ai-memory](https://github.com/akitaonrails/ai-memory) | 1455 | Rust | MIT | 2026-05-21 | Git-versioned markdown wiki, zero LLM mode, cross-agent handoffs |
| [LangMem](https://github.com/langchain-ai/langmem) | 1604 | Python | MIT | 2025-02 | LangChain memory toolkit — library only, no CLI/plugin, requires API keys |
| [memanto](https://github.com/moorcheh-ai/memanto) | 1792 | Python | MIT | 2026-03 | Vector-only (no graph), 13 memory types, 5 search modes, LoCoMo 87.1% SOTA |
...
| [MemMachine](https://github.com/MemMachine/MemMachine) | 3351 | Python | Apache 2.0 | 2025-08 | Agentic retrieval with ChainOfQueryAgent multi-hop, 3-layer memory, Neo4j+PG |
| [MIRIX](https://github.com/MIRIX-AI/MIRIX) | 3481 | Python | MIT | 2025-09 | 6-type memory architecture, LoCoMo 85.38% SOTA, 99.9% storage reduction, best extraction pipeline |
| [Acontext](https://github.com/memodb-io/Acontext) | 3667 | JS/TS/Go/Python | Apache-2.0 | 2025-10 | Agent Skills as a Memory Layer — auto-captures learnings as Markdown skill files, progressive disclosure retrieval |
...
| [obsidian-mind](https://github.com/breferrari/obsidian-mind) | 4330 | TypeScript | MIT | 2026-02-28 | Obsidian vault template, markdown-native memory, QMD hybrid RRF search |
...
| [OpenMemory](https://github.com/CaviraOSS/OpenMemory) | 4426 | Python | Apache 2.0 | 2025-10 | HMD v2 cognitive engine: 5-sector decay, temporal KG, waypoint graph, document ingestion |
| [memory-lancedb-pro](https://github.com/CortexReach/memory-lancedb-pro) | 4462 | TypeScript | MIT | 2025-11 | LanceDB plugin: 6-stage hybrid pipeline, Weibull decay, dreaming sidecar, multi-scope |
...
| [ByteRover](https://github.com/campfirein/byterover-cli) | 4938 | TypeScript | Elastic 2.0 | 2025-06-19 | Context tree with git-like VC, strongest benchmarks (LoCoMo 96.1) |
| [engram](https://github.com/Gentleman-Programming/engram) | 5988 | Go | MIT | 2026-02-16 | Go binary agent memory with conflict surfacing and TUI |
| [Honcho](https://github.com/plastic-labs/honcho) | 6600 | Python | AGPL-3.0 | 2024-04 | Memory library for stateful agents, theory-of-mind reasoning, multi-agent capable |
| [MemOS](https://github.com/MemTensor/MemOS) | 10690 | Python | Apache 2.0 | 2025-10 | Self-evolving memory OS, L1/L2/L3, MemCubes, time machine, strong benchmarks |
| [EverOS](https://github.com/EverMind-AI/EverOS) | 11988 | Python | Apache 2.0 | 2025-10-28 | Self-evolving agent memory with evaluation framework |
...
| [Memori](https://github.com/MemoriLabs/Memori) | 15753 | Python | Apache 2.0 | 2025-07-24 | Agent-native memory (captures execution, not just conversation) |
| [Memvid](https://github.com/memvid/memvid) | 16214 | Rust | Apache 2.0 | 2025-05-27 | Single-file memory (.mv2) with Smart Frames and time-travel |
| [hindsight](https://github.com/vectorize-io/hindsight) | 19859 | Python | MIT | 2025-10 | Self-improving agentic memory, 91.4% LongMemEval, reflect engine, web dashboard |
| [Letta](https://github.com/letta-ai/letta) | 24224 | Python | Apache-2.0 | 2023-10 | Stateful agent platform, 3-tier memory (core/recall/archival), sleep-time dreaming |
| [agentmemory](https://github.com/rohitg00/agentmemory) | 26950 | TypeScript | Apache 2.0 | 2026-02-25 | 53 MCP tools, 12 hooks, 4-tier lifecycle, 3-way RRF, pi native |
| [gbrain](https://github.com/garrytan/gbrain) | 28243 | TypeScript | MIT | 2025-07 | Garry Tan's production agent brain: zero-LLM KG, gap-aware synthesis, PGLite, dream cycle |
| [OpenViking](https://github.com/volcengine/OpenViking) | 28340 | Python | AGPL-3.0 | 2026-01-05 | ByteDance context DB, filesystem paradigm, L0/L1/L2 tiers, LoCoMo 82% |
| [Supermemory](https://github.com/supermemoryai/supermemory) | 28888 | TypeScript | MIT | 2024 | Cloud memory API, hybrid RAG+Memory, #1 benchmarks, Chrome ext+MCP+plugins |
| [Graphiti](https://github.com/getzep/graphiti) | 29873 | Python | Apache 2.0 | 2024-08-08 | Temporal knowledge graph engine (powers Zep) |
| [Cognee](https://github.com/topoteretes/cognee) | 29991 | Python | Apache 2.0 | 2023-08-16 | Memory control plane with remember/recall/forget/improve API |
| [Nanobot](https://github.com/HKUDS/nanobot) | 46877 | Python | MIT | 2025-05 | 43.3k star AI agent framework — Dream is one subsystem, NOT dedicated memory |
| [MemPalace](https://github.com/MemPalace/mempalace) | 58331 | Python | MIT | 2026-04-05 | Verbatim storage, palace metaphor, 96.6% LongMemEval raw retrieval |
| [Mem0](https://github.com/mem0ai/mem0) | 63163 | Python | Apache 2.0 | 2023-06-20 | Memory-as-a-Service platform with best published benchmarks |
| [claude-mem](https://github.com/thedotmack/claude-mem) | 90586 | TypeScript | Apache 2.0 | 2025-08-31 | Hooks-based observation capture with progressive disclosure |
...
| CommonGround | 147 | TypeScript | MIT | — | 2025-11 | 8% |
| Mengram | 171 | Python | Apache 2.0 | — | 2026-02-10 | 37% |
| ClawMem | 198 | TypeScript | MIT | — | 2026-02-06 | 38% |
| omega-memory | 200 | Python | MIT | — | 2026-01 | 43% |
...
| AIPass | 254 | Python | MIT | — | 2026-02 | 28% |
| shodh-memory | 268 | Rust | ? | ✅ | 2025-12-03 | 32% |
...
| stash | 762 | Go | Apache 2.0 | ✅ | 2026-04-24 | 33% |
| Wax | 776 | Swift | Apache 2.0 | ✅ | 2026-01-20 | 17% |
| LightMem | 1079 | Python | MIT | — | 2025-05 | 3% |
| token-savior | 1113 | Python | MIT | — | 2026-03-30 | 28% |
| mem9 | 1183 | TypeScript | Apache 2.0 | — | 2026-01 | 33% |
| nocturne | 1313 | Python | MIT | — | 2025-12-25 | 23% |
| opencode-mem | 1339 | TypeScript | ? | — | 2026-01-10 | 15% |
| ai-memory | 1455 | Rust | MIT | ✅ | 2026-05-21 | 32% |
| LangMem | 1604 | Python | MIT | — | 2025-02 | 3% |
| memanto | 1792 | Python | MIT | — | 2026-03 | 28% |
| memsearch | 1861 | Python | Apache 2.0 | — | 2025-08 | 18% |
| mcp-memory-service | 1901 | Python | Apache 2.0 | — | 2024-12-26 | 68% |
| MemMachine | 3351 | Python | Apache 2.0 | — | 2025-08 | 32% |
| MIRIX | 3481 | Python | MIT | — | 2025-09 | 40% |
| Acontext | 3667 | JS/TS/Go/Python | Apache-2.0 | — | 2025-10 | 22% |
| MemoryBear | 4167 | Python | Apache 2.0 | — | 2025-06 | 55% |
| obsidian-mind | 4330 | TypeScript | MIT | — | 2026-02-28 | 22% |
| m_flow | 4419 | Python | Apache 2.0 | — | 2026-02 | 23% |
| OpenMemory | 4426 | Python | Apache 2.0 | — | 2025-10 | 25% |
| memory-lancedb-pro | 4462 | TypeScript | MIT | — | 2025-11 | 15% |
| TencentDB-AM | 4506 | TypeScript | MIT | — | 2026-04-07 | 17% |
| ByteRover | 4938 | TypeScript | Elastic 2.0 | — | 2025-06-19 | 25% |
| engram | 5988 | Go | MIT | ✅ | 2026-02-16 | 38% |
| Honcho | 6600 | Python | AGPL-3.0 | — | 2024-04 | 18% |
| MemOS | 10690 | Python | Apache 2.0 | — | 2025-10 | 27% |
| EverOS | 11988 | Python | Apache 2.0 | — | 2025-10-28 | 23% |
| memU | 13700 | Python | MIT | — | 2025-09 | 17% |
| Memori | 15753 | Python | Apache 2.0 | — | 2025-07-24 | 15% |
| Memvid | 16214 | Rust | Apache 2.0 | — | 2025-05-27 | 17% |
| hindsight | 19859 | Python | MIT | — | 2025-10 | 20% |
| Letta | 24224 | Python | Apache-2.0 | — | 2023-10 | 20% |
| agentmemory | 26950 | TypeScript | Apache 2.0 | — | 2026-02-25 | 43% |
| gbrain | 28243 | TypeScript | MIT | — | 2025-07 | 35% |
| OpenViking | 28340 | Python | AGPL-3.0 | — | 2026-01-05 | 28% |
| Supermemory | 28888 | TypeScript | MIT | — | 2024 | 47% |
| Graphiti | 29873 | Python | Apache 2.0 | — | 2024-08-08 | 25% |
| Cognee | 29991 | Python | Apache 2.0 | — | 2023-08-16 | 17% |
| Nanobot | 46877 | Python | MIT | — | 2025-05 | 12% |
| MemPalace | 58331 | Python | MIT | — | 2026-04-05 | 15% |
| Mem0 | 63163 | Python | Apache 2.0 | — | 2023-06-20 | 17% |
| claude-mem | 90586 | TypeScript | Apache 2.0 | — | 2025-08-31 | 27% |
