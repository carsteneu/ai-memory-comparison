...
[![Systems](https://img.shields.io/badge/systems-72-blue?style=flat)](https://carsteneu.github.io/ai-memory-comparison/)
...
>
> 72 systems, 79 features, source-backed. Every ✅ links to the exact code or docs that prove it.

## What this is

A feature-level comparison of memory systems for AI coding agents. 72 systems compared across 79 features on seven axes: Data Model, Search & Retrieval, Knowledge Lifecycle, Extraction Pipeline, Platform Support, Architecture, and Benchmarks. Every claim backed by a public source citation — no marketing, no inference.
...
- **Read the evidence:** `evidence/` directory, one file per system, citations to specific source lines
...
[![Star History Chart](https://api.star-history.com/svg?repos=carsteneu/ai-memory-comparison&type=Date)](https://star-history.com/#carsteneu/ai-memory-comparison&Date)

## Disclosure

This comparison is maintained by the author of [YesMem](https://github.com/carsteneu/yesmem). YesMem is listed alongside every other system and follows the same evidence rules.
